...
hosts_path = r'C:\Windows\System32\drivers\etc\hosts'  # r' means raw string, no spec character like \
hosts_temp = r'D:\Dropbox\_PYTHON\Udemy_mega_course\app3_website_blocker\hosts'
redirect = '127.0.0.1'
